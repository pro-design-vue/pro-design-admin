...
import { localCache, StorageManager } from '@/shared/cache'
import { isMacOs, merge } from '@/shared/utils'
...
class PreferenceManager {
   ...
   * namespace  命名空间
   */
  public async initPreferences({ overrides, useCache }: InitialOptions) {
    // 是否初始化过
    ...
    // 加载并合并当前存储的偏好设置
    const mergedPreference = this.useCache
      ? merge(
          {},
          // overrides,
