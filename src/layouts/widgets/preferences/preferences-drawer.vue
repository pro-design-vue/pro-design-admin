...
import { App, Segmented, Badge } from 'ant-design-vue'
import { ProDrawer, ProButton } from 'pro-design-vue'
...
import { CopyIcon, RotateCwIcon } from '@/icons'
...
async function handleCopy() {
  ...
  notification.success({
    ...
    message: $t('preferences.copyPreferencesSuccessTitle'),
    description: $t('preferences.copyPreferencesSuccess'),
  })
}
...
<template>
  <div>
    <ProDrawer
      ...
      :width="384"
      root-class-name="preferences"
    >
      <template #extra>
        <Badge :dot="!!diffPreference" status="processing" :offset="[-5, 5]">
          <ProButton
            size="small"
            shape="circle"
            type="text"
      ...
      <Segmented v-model:value="activeTab" :options="tabs" block></Segmented>
      <div class="preferences-wrap">
        ...
        <div v-show="activeTab === 'shortcutKey'">
      ...
      <template #footer>
        <div class="preferences-footer">
          <ProButton
            class="preferences-footer-btn"
            :disabled="!diffPreference"
            type="primary"
            @click="handleCopy"
          >
            <template #icon>
              <CopyIcon style="margin-right: 8px; vertical-align: -1.75px" />
            </template>
